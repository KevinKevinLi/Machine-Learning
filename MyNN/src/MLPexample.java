...
public class MLPexample {
    public static void main(String[] args) throws Exception {
        ...
        String filepath= "data/Stock/OHLVC-O-Train.csv";
        ...
        filepath= "data/Stock/OHLVC-O-Test.csv";
        ...
        NetworkConfigration configuration=new NetworkConfigration()
                .base(0.5)//learningrate,(momentum),(time seed)
        ...
        NewNetwork.train(TrainSet.ReturnRecord(input_num,output_num),1500);
        ...
        //customized predict
        NewNetwork.predict(TestSet.ReturnRecord(input_num,output_num),"./data/ChartOutput/5line.png");
    }
}
